...
const Cart = () => {
  ...
  return (
    <div>
      {cart.length > 0 ? (
        <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row justify-center max-[600px]:mt-24">
          ...
          <div className="w-[100%] md:w-[40%] mt-5  flex flex-col">
            <div className="flex flex-col p-5 gap-5 my-14  h-[100%] justify-between max-[600px]:items-center">
            ...
            <div className="flex flex-col max-[600px]:items-center">
              ...
              <button
                className="bg-green-700 hover:bg-purple-50 rounded-lg text-white transition duration-300 ease-linear mb-16 mt-5 border-2 border-green-600 font-bold hover:text-green-700 p-3 text-xl"
